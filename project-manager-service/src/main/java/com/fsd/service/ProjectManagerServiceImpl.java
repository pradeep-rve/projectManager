...
public class ProjectManagerServiceImpl implements ProjectManagerService {
	...
	public List<ProjectInfo> getProject() throws TaskException {
		LOGGER.debug("Inside getProject() of ProjectManagerServiceImpl - Start");
		...
		try {
			...
			LOGGER.error("Exception in getProject() of ProjectManagerServiceImpl " + e);
			throw new TaskException("1000", "Technical Error", 500);
		}
		LOGGER.debug("Inside getProject() of ProjectManagerServiceImpl - End");
		return projectInfo;
	}
	...
	public List<UserInfo> getUser() throws TaskException {
		LOGGER.debug("Inside getUser() of ProjectManagerServiceImpl - Start");
		...
		try {
			...
			LOGGER.error("Exception in getUser() of ProjectManagerServiceImpl " + e);
			throw new TaskException("1000", "Technical Error", 500);
		}
		LOGGER.debug("Inside getUser() of ProjectManagerServiceImpl - End");
		return userInfo;
	}
	 ...
	 */
	@Override
	public List<TaskInfo> getTask(int projectId) throws TaskException {
		LOGGER.debug("Inside getTask() of ProjectManagerServiceImpl - Start");
		...
		try {
			...
			LOGGER.error("Exception in getTask() of ProjectManagerServiceImpl " + e);
			throw new TaskException("1000", "Technical Error", 500);
		}
		LOGGER.debug("Inside getTask() of ProjectManagerServiceImpl - End");
		return taskInfo;
	}
